			...
			<div class="main-page">
				<div class="tables">
					...
					<div class="bs-example widget-shadow" data-example-id="contextual-table"> 
						<h4>Cadres Table:</h4>
						<table class="table"> <thead> <tr> <th>#</th> <th>CIN</th> <th>NOM-PRENOM</th> <th>Profession</th> <th>Delete</th> </tr> </thead> <tbody> <tr class="active"> 
...
for(User user: list){
 ...
 if (!("Etudiant".equals(profession)||("Teacher".equals(profession)))){
...
<th scope="row"><%= i %></th>
						...
						<td><form action="result.jsp" method="get">
   <input type="hidden" name="id1" value="<%= cin %>">
