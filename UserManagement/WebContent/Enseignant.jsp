			...
			<div class="main-page">
				<div class="tables">
					...
					<div class="bs-example widget-shadow" data-example-id="contextual-table"> 
						<h4>Cadres Table:</h4>
						<table class="table"> <thead> <tr> <th>#</th> <th>CIN</th> <th>NOM-PRENOM</th> <th>Profession</th> <th>Matiere</th><th>Type</th><th>Delete</th> </tr> </thead> <tbody> <tr class="active"> 
...
for(User user: list){
 ...
 if ("Teacher".equals(profession)){
   String matiere=user.getMatiere();
...
<th scope="row"><%= i %></th>
   ...
   <input type="hidden" name="id3" value="<%= cin %>">
